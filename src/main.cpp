...
int main() {
  ...
  GlfwWindow *window =
      builder.setFramebufferSizeCallback(framebuffer_size_callback)
  ...
  auto skybox_shader =
      Shader{"resources/shaders/skybox.vs", "resources/shaders/skybox.fs"};
  auto instance_shader =
      Shader{"resources/shaders/instance.vs", "resources/shaders/instance.fs"};

  auto lights_shader =
      Shader{"resources/shaders/lights.vs", "resources/shaders/lights.fs"};
  auto lights_box_shader =
      Shader{"resources/shaders/lights.vs", "resources/shaders/lights_box.fs"};
  auto lights_blur_shader = Shader{"resources/shaders/lights_blur.vs",
                                   "resources/shaders/lights_blur.fs"};
  auto lights_merger_shader = Shader{"resources/shaders/lights_merger.vs",
                                     "resources/shaders/lights_merger.fs"};
  ...
  auto bloom = Bloom{lights_shader, lights_box_shader, lights_blur_shader,
                     lights_merger_shader};
  ...
  while (!window->shouldClose()) {
    ...
    glm::mat4 projection = glm::perspective(
        glm::radians(programState->camera.Zoom), aspect, 0.1f, 100.0f);
    ...
    // render floating point color buffer to 2D quad and tonemap HDR colors to
