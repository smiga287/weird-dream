...
void ImGuiFacade::draw(ProgramState *programState) {
...

  {
    ...
    ImGui::DragFloat3("Building position",
                      (float *)&programState->building_position);
    ImGui::DragFloat("Building scale", &programState->building_scale, 0.05, 0.1,
                     8.0);
...

  {
    ...
    ImGui::Checkbox("Camera mouse update",
                    &programState->is_camera_mouse_movement_enabled);
    ImGui::End();
  }
