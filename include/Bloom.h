...
class Bloom {
public:
    Bloom(const Shader& lights_shader, const Shader& lights_box_shader, const Shader& lights_blur_shader, const Shader& lights_merger_shader);
...
private:
    ...
    uint rboDepth_;
    std::array<uint, 2> attachments_ = { GL_COLOR_ATTACHMENT0, GL_COLOR_ATTACHMENT1 };
